...
(function (a) {
        ...
        "Extensions/FullScreen.js", [a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Utilities.js"]], function (a, e, r, x) {
            ...
            x = function () {
                ...
                a.prototype.close = function () {
                    var d = this.chart, a = d.options.chart;
                    if (this.isOpen && this.browserProps && d.container.ownerDocument instanceof
                ...
                a.prototype.open = function () {
                    var d = this, a = d.chart, b = a.options.chart;
                ...
                a.prototype.setButtonText = function () {
                    var d = this.chart, a = d.exportDivElements,
                        b = d.options.exporting, t = b && b.buttons && b.buttons.contextButton.menuItems;
                    d = d.options.lang;
    ...
    g(a, "Extensions/Exporting/ExportingSymbols.js", [], function () {
        ...
        (function (a) {
            function e(a, d, e, b) {
                return [["M", a, d + 2.5], ["L", a + e, d + 2.5], ["M", a, d + b / 2 + .5], ["L", a + e, d + b / 2 + .5], ["M", a, d + b - 1.5], ["L", a + e, d + b - 1.5]]
            }
    ...
    g(a, "Core/HttpUtilities.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, e) {
        var p = a.doc, g = e.createElement, B = e.discardElement, t = e.merge, d = e.objectEach, J = {
            ajax: function (a) {
                ...
                J.ajax({url: a, success: d, dataType: "json", headers: {"Content-Type": "text/plain"}})
            }, post: function (a, e, r) {
                var b = g("form", t({
                    method: "post",
                    action: a,
                    enctype: "multipart/form-data"
                }, r), {display: "none"}, p.body);
                d(e, function (a, d) {
                    g("input", {type: "hidden", name: d, value: a}, null, b)
                });
                b.submit();
                B(b)
            }
    ...
    g(a, "Extensions/Exporting/Exporting.js",
        [a["Core/Renderer/HTML/AST.js"], a["Core/Chart/Chart.js"], a["Core/Chart/ChartNavigationComposition.js"], a["Core/DefaultOptions.js"], a["Extensions/Exporting/ExportingDefaults.js"], a["Extensions/Exporting/ExportingSymbols.js"], a["Core/Globals.js"], a["Core/HttpUtilities.js"], a["Core/Utilities.js"]], function (a, e, g, x, B, t, d, J, b) {
            e = x.defaultOptions;
            var p = d.doc, r = d.win, z = b.addEvent, q = b.css, E = b.createElement, L = b.discardElement,
                F = b.extend, P = b.find, G = b.fireEvent, Q = b.isObject, m = b.merge, R = b.objectEach, y = b.pick,
                S = b.removeEvent, T = b.uniqueKey, H;
            (function (e) {
                function x(a) {
                    var c = this, d = c.renderer, b = m(c.options.navigation.buttonOptions, a), e = b.onclick,
                        l = b.menuItems, n = b.symbolSize || 12;
                    c.btnCount || (c.btnCount = 0);
                    c.exportDivElements || (c.exportDivElements = [], c.exportSVGElements = []);
                    if (!1 !== b.enabled && b.theme) {
                        var f = b.theme, C = f.states, p = C && C.hover;
                        C = C && C.select;
                        var D;
                        ...
                        var k = d.button(b.text, 0, 0, D, f, p, C).addClass(a.className).attr({title: y(c.options.lang[b._titleKey || b.titleKey], "")});
                        k.menuClassName = a.menuClassName || "highcharts-menu-" + c.btnCount++;
                        if (b.symbol) {
                            var g = d.symbol(b.symbol, b.symbolX - n / 2, b.symbolY - n / 2, n, n, {
                                width: n,
                                height: n
                            }).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(k);
                            c.styledMode || g.attr({
                ...
                function B() {
                    if (this.printReverseInfo) {
                        var a = this.printReverseInfo,
                            b = a.childNodes, d = a.origDisplay;
                        a = a.resetParams;
                ...
                function H() {
                    var a = p.body, b = this.options.exporting.printMaxWidth,
                        d = {childNodes: a.childNodes, origDisplay: [], resetParams: void 0};
                    this.isPrinting = !0;
                    this.pointer.reset(null, 0);
                    G(this, "beforePrint");
                    b && this.chartWidth > b && (d.resetParams = [this.options.chart.width,
                        void 0, !1], this.setSize(b, void 0, !1));
                ...
                function U(c, d, e, A, g, l, n) {
                    var f = this, u = f.options.navigation, w = f.chartWidth, D = f.chartHeight, k = "cache-" + c,
                        v = Math.max(g, l), h = f[k];
                    if (!h) {
                        f.exportContextMenu = f[k] = h = E("div", {className: c}, {
                            position: "absolute",
                            zIndex: 1E3, padding: v + "px", pointerEvents: "auto"
                        }, f.fixedDiv || f.container);
                        var m = E("ul", {className: "highcharts-menu"}, {listStyle: "none", margin: 0, padding: 0}, h);
                        f.styledMode || q(m, F({
                        ...
                        h.hideMenu = function () {
                            ...
                            n && n.setState(0);
                            f.openMenu = !1;
                            q(f.renderTo, {overflow: "hidden"});
                            q(f.container, {overflow: "hidden"});
                        ...
                        d.forEach(function (c) {
                            ...
                            if (Q(c, !0)) {
                                ...
                                }, q(b, F({cursor: "pointer"}, u.menuItemStyle || {}))));
                    ...
                    q(h, d);
                    q(f.renderTo, {overflow: ""});
                    q(f.container, {overflow: ""});
                    f.openMenu = !0;
                    G(f, "exportMenuShown")
                }

                function V(a) {
                    var c = a ? a.target : this, d = c.exportSVGElements, e = c.exportDivElements;
                    a = c.exportEvents;
                    var g;
                ...
                function Z(a) {
                    ...
                    }, p.body), e = this.renderTo.style.width;
                    ...
                    this.axes.forEach(function (a) {
                        ...
                        a.options.isInternal || (n[a.coll] || (n[a.coll] = !0, c[a.coll] = []), c[a.coll].push(m(a.userOptions, {visible: a.visible})))
                    });
                ...
                function aa(a, b) {
                    ...
                    return this.getSVG(m({chart: {borderRadius: 0}}, c.chartOptions,
                        b, {
                            exporting: {
                ...
                function ba() {
                    function a(c) {
                        ...
                        if (1 === c.nodeType && -1 === ca.indexOf(c.nodeName)) {
                            ...
                            for (var q in k) if (d.isFirefox || d.isMS || d.isSafari || Object.hasOwnProperty.call(k, q)) {
                                var w = k[q], l = q;
                                h = f = !1;
                                if (g.length) {
                    ...
                    var b = da, g = e.inlineWhitelist, A = {}, v, l = p.createElement("iframe");
                    q(l, {width: "1px", height: "1px", visibility: "hidden"});
                ...
                function ia() {
                    var a = this, b = a.options.exporting, d = b.buttons,
                        e = a.isDirtyExporting || !a.exportSVGElements;
                    a.buttonOffset = 0;
                    a.isDirtyExporting && a.destroyExport();
                    e && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({zIndex: 3}).add(), R(d, function (b) {
                        a.addButton(b)
                ...
                e.inlineWhitelist =
                    [];
                var ca = ["clipPath", "defs", "desc"], I;
                e.compose = function (a, b) {
                    t.compose(b);
                    -1 === O.indexOf(a) && (O.push(a), b = a.prototype, b.afterPrint = B, b.exportChart = W, b.inlineStyles = ba, b.print = ha, b.sanitizeSVG = ja, b.getChartHTML = X, b.getSVG = Z, b.getSVGForExport = aa, b.getFilename = Y, b.moveContainers = ea, b.beforePrint = H, b.contextMenu = U, b.addButton = x, b.destroyExport = V, b.renderExporting = ia, b.callbacks.push(K), z(a, "init", fa), d.isSafari && d.win.matchMedia("print").addListener(function (a) {
